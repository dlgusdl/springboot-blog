...
INSERT INTO reply_tb(comment, user_id, board_id, created_at) values('댓글 1', 1, 1, now());
INSERT INTO reply_tb(comment, user_id, board_id, created_at) values('댓글 2', 1, 2, now());
INSERT INTO reply_tb(comment, user_id, board_id, created_at) values('댓글 3', 2, 1, now());
INSERT INTO reply_tb(comment, user_id, board_id, created_at) values('댓글 4', 2, 2, now());
